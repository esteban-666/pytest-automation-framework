...
class TestDemoQA:
    ...
    def testFormSubmission(self):
        ...
        try:
            ...
            self.log_step("STEP 1", "Navigate to DemoQA practice form", "Practice form page loads")
            print("   🌐 Navigating to https://demoqa.com/automation-practice-form")
            self.driver.get("https://demoqa.com/automation-practice-form")
            print("   ✅ Practice form page loaded")
            
            # ===== STEP 2: FILL PERSONAL INFORMATION =====
            self.log_step("STEP 2", "Fill personal information fields", "All personal fields populated")
            ...
            self.log_step("STEP 4", "Enter mobile number", "Mobile number field populated")
            ...
            self.log_step("STEP 6", "Select subjects", "Computer Science subject selected")
            ...
            # ===== STEP 9: SUBMIT FORM =====
            self.log_step("STEP 9", "Submit the form", "Form submitted and modal appears")
            print("   📤 Submitting form...")
            self.page.click_element((By.ID, "submit"))
            print("   ✅ Form submitted")
            
            # ===== STEP 10: VERIFY SUBMISSION =====
            self.log_step("STEP 10", "Verify form submission", "Success modal displayed with correct message")
            print("   🔍 Checking for submission modal...")
            assert self.page.is_element_present((By.CLASS_NAME, "modal-content")), "Modal not displayed"
            print("   ✅ Submission modal is present")
            
            modal_title = self.page.get_text((By.CLASS_NAME, "modal-title"))
            print(f"   📄 Modal title: {modal_title}")
            assert "Thanks for submitting the form" in modal_title, "Incorrect modal title"
    ...
    def testDragDrop(self):
        ...
        try:
            ...
            self.log_step("STEP 1", "Navigate to droppable page", "Droppable page loads")
            ...
            self.log_step("STEP 2", "Locate draggable and droppable elements", "Elements found")
            ...
            self.log_step("STEP 3", "Perform drag and drop operation", "Element dragged and dropped")
            ...
            self.log_step("STEP 4", "Verify drop was successful", "Droppable text shows 'Dropped!'")
    ...
    def testDynamicProperties(self):
        ...
        try:
            ...
            self.log_step("STEP 1", "Navigate to dynamic properties page", "Dynamic properties page loads")
            ...
            self.log_step("STEP 2", "Wait for button to be enabled", "Button becomes clickable after 5 seconds")
            print("   ⏱️ Waiting for button to be enabled (timeout: 10 seconds)...")
            assert self.page.is_element_clickable((By.ID, "enableAfter"), timeout=10), "Button not enabled"
            print("   ✅ Button is now enabled")
            
            # ===== STEP 3: CLICK THE ENABLED BUTTON =====
            self.log_step("STEP 3", "Click the enabled button", "Button clicked successfully")
            ...
            self.log_step("STEP 4", "Verify color change on color button", "Button color has changed")
            ...
            assert color != "rgba(255, 255, 255, 1)", f"Button should not be white, got: {color}"
    ...
    def testAlertsFrames(self):
        ...
        try:
            ...
            self.log_step("STEP 1", "Navigate to alerts and windows page", "Alerts page loads")
            ...
            self.log_step("STEP 2", "Test simple alert", "Alert appears and is accepted")
            ...
            self.log_step("STEP 3", "Test confirm alert", "Confirm alert appears and is accepted")
            ...
            self.log_step("STEP 4", "Test prompt alert", "Prompt alert appears, text entered, and accepted")
    ...
    def testBookStore(self):
        ...
        try:
            ...
            self.log_step("STEP 3", "Verify search results", "Books found in search results")
            ...
            if books:
                ...
                self.log_step("STEP 5", "Verify book details page", "Book details page displayed")
                print("   🔍 Checking book details page...")
                assert self.page.is_element_present((By.CLASS_NAME, "profile-wrapper")), "Book details page not loaded"
    ...
    def testWidgets(self):
        ...
        try:
            ...
            self.log_step("STEP 2", "Test accordion functionality", "Accordion section expands")
            ...
            assert self.page.is_element_visible((By.ID, "section1Content")), "Accordion content not visible"
            ...
            assert self.page.is_element_visible((By.ID, "demo-tabpane-what")), "Tab content not visible"
            print("   ✅ Tab content is visible")
            
            # ===== STEP 4: TEST TOOLTIPS =====
            self.log_step("STEP 4", "Test tooltip functionality", "Tooltip appears on hover")
            ...
            assert self.page.is_element_present((By.CLASS_NAME, "tooltip-inner")), "Tooltip not present"
    ...
    def testProgressBar(self):
        ...
        try:
            ...
            self.log_step("STEP 1", "Navigate to progress bar page", "Progress bar page loads")
            ...
            self.log_step("STEP 3", "Wait for progress completion", "Progress bar reaches 100%")
            print("   ⏱️ Waiting for progress to complete (timeout: 30 seconds)...")
            self.page.wait_for_element_to_disappear((By.CLASS_NAME, "progress-bar"), timeout=30)
            ...
            assert "100%" in progress_text, f"Progress should be 100%, got: {progress_text}"
    ...
    def testCriticalFlow(self):
        ...
        try:
            ...
            self.log_step("STEP 1", "Navigate to DemoQA main page", "Main page loads with ToolsQA title")
            print("   🌐 Navigating to https://demoqa.com/")
            self.driver.get("https://demoqa.com/")
            print("   ✅ Main page loaded")
            
            # ===== STEP 2: VERIFY PAGE LOADS =====
            self.log_step("STEP 2", "Verify main page loads correctly", "Page title contains ToolsQA")
            print("   🔍 Checking page title...")
            page_title = self.page.get_page_title()
            print(f"   📄 Page title: {page_title}")
            
            assert "ToolsQA" in page_title, f"Expected 'ToolsQA' in title, got: {page_title}"
            print("   ✅ Main page verification passed")
            
            # ===== STEP 3: NAVIGATE TO ELEMENTS =====
            self.log_step("STEP 3", "Navigate to elements section", "Elements page loads")
            print("   🔗 Clicking on Elements card...")
            self.page.click_element((By.XPATH, "//div[contains(@class, 'card-body') and contains(text(), 'Elements')]"))
            print("   ✅ Elements card clicked")
            
            # ===== STEP 4: VERIFY ELEMENTS PAGE =====
            self.log_step("STEP 4", "Verify elements page loads", "Elements page title contains 'Elements'")
            print("   🔍 Checking elements page title...")
            elements_title = self.page.get_page_title()
            print(f"   📄 Elements page title: {elements_title}")
            
            assert "Elements" in elements_title, f"Expected 'Elements' in title, got: {elements_title}"
            print("   ✅ Elements page verification passed")
            
            # ===== STEP 5: TEST TEXT BOX =====
            self.log_step("STEP 5", "Test text box functionality", "Text box form submitted successfully")
            ...
            self.log_step("STEP 6", "Verify text box submission", "Output element is present")
            print("   🔍 Checking for output element...")
            assert self.page.is_element_present((By.ID, "output")), "Output element not present"
