...
class DemoQAMainPage(BasePage):
    ...
    ELEMENTS_CARD = (
        By.XPATH,
        "//div[contains(@class, 'card-body')]//h5[text()='Elements']",
    )
    FORMS_CARD = (By.XPATH, "//div[contains(@class, 'card-body')]//h5[text()='Forms']")
    WIDGETS_CARD = (
        By.XPATH,
        "//div[contains(@class, 'card-body')]//h5[text()='Widgets']",
    )
    INTERACTIONS_CARD = (
        By.XPATH,
        "//div[contains(@class, 'card-body')]//h5[text()='Interactions']",
    )
    BOOK_STORE_CARD = (
        By.XPATH,
        "//div[contains(@class, 'card-body')]//h5[text()='Book Store Application']",
    )
