...
class WebDriverManager:
    ...
    def get_driver(self, browser: str = None, headless: bool = None, **kwargs) -> webdriver.Remote:
        """
        ...
        headless = headless if headless is not None else self.config.get("browser.headless", True)
        ...
        # Set window size
        window_size = self.config.get("web.window_size", {"width": 1920, "height": 1080})
